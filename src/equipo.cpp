...
equipo::equipo(string abrev):
  Njugadores(GetUsedLines(abrev+".txt")-2), //El n�mero de jugadores es el numero de lineas menos 2
...
void equipo::Load()
{
  ...
  //Bloque de c�lculo (lectura de fichero)
...
void equipo::Save()
{
  ...
  fichero << "----------------------------------------------------------------------------------------------------------------" << endl;
  //Volcado de la informaci�n en el fichero
...
string equipo::VetoedGK()
{
  ...
  //Tengo el portero suplente, hay que mirar que est� disponible
